...
const technologies: TechnologySignal[] = [{ name: "React", category: "framework", evidence: ["package.json: react"] }];
const skills: SkillEvidence[] = [{
  skill: "TypeScript", level: "Good Evidence", explanation: "Types", origin: "deterministic",
  evidence: [{ file: "src/app.ts", summary: "Types", implementationExample: "Typed input", origin: "deterministic" }],
}];
